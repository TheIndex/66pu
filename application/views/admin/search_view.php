...
<?php
	if($resp->total_results == 0){
		...
		foreach($resp->getData() as $taobaoke_item){
		?>
			<li>
				...
				<p>
					<span class="right"><?php echo $taobaoke_item->volume ?>件/30天</span><span><?php echo $taobaoke_item->commission_num ?></span> /
					<span><?php echo $taobaoke_item->promotion_price?></span></p>
			</li>
		<?php
		}
	}
